package com.apecs.im.view.activity.main;
...
import com.apecs.im.base.App;
import com.apecs.im.base.BaseActivity;
import com.apecs.im.presenter.main.MainPresenterImpl;
import com.apecs.im.utils.ToastUtil;
import com.apecs.im.view.fragment.business.BusinessFragment;
import com.apecs.im.view.fragment.car.CarFragment;
import com.apecs.im.view.fragment.dialogue.DialogueFragment;
import com.apecs.im.view.fragment.me.MeFragment;
import com.apecs.im.view.fragment.nearby.NearByFragment;
import com.apecs.im.widget.CustomPopWindow;
...
public class MainActivity extends BaseActivity<MainPresenterImpl> implements MainView {
    ...
    public void enventMessage(UserEvent userEvent) {
        if (userEvent.flag == 0) {
