package com.apaces.demo.utils.xmpp;
...
import com.apaces.demo.utils.FormatTools;
...
//                        .setUsernameAndPassword("账号","密码") // 构建的时候先传入账号密码，当连接成功的时候会自动进行授权登录
                        .setHost(Urls.SERVER_HOST)//IP地址
                        .setPort(Urls.SERVER_PORT)//端口
                        .setServiceName(Urls.SERVER_NAME)//域名
    ...
    public List<User> searchUser(String key) {
        ...
        try {
            ...
            Form searchForm = search.getSearchForm("search." + Urls.SERVER_NAME);
            ...
            ReportedData data = search.getSearchResults(answerForm, "search." + Urls.SERVER_NAME);
    ...
    public boolean addUser(String userName) {
        ...
        try {
            LogUtils.d("onResponse", getFullUsername(userName));
    ...
    public static String getFullUsername(String username) {
        ...
        return username + "@" + Urls.SERVER_NAME;
    }
